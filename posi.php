            ...
            <div class="row">
                <div class="col-12 col-xs-12 tabs-body">
                    <div class="tabs">
                        ...
                        <a class="first-tab" href="https://posigraph.com/posigraph_new/dashboard.php"> Feed </a>
                        <input id="tab2-2" name="tabs-two" type="radio" checked="checked">
                          
                        </div>

                        <div class="tab-2">
                        <a class="first-tab" href="https://posigraph.com/posigraph_new/battle/battle.php"> Story </a>                            
