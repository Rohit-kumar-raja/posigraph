...
function getPost($from,$count) 
{
       global $conn;  
        ...
        $result=mysqli_query($conn,$checkPost);
         if($result)
         {
            ...
            $me=$_SESSION['id'];
            // echo "select * from battle where player1_id IN($friends,$me) OR player2_id IN($friends,$me) ORDER BY date_of_creation LIMIT $from,$count";
    ...
    <?php
        ...
        $p1_battle_num = $p1_battle_num==''?0:$p1_battle_num;
        $p2_battle_num = $p2_battle_num==''?0:$p2_battle_num;
